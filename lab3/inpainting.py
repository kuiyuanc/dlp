...
from utils import LoadMaskData, LoadTestData
        ...
        with torch.no_grad():
            ...
            for step in range(self.total_iter):
                if step == self.sweet_spot:
                    break
                ratio += 1 / self.total_iter  # this should be updated
...
if __name__ == "__main__":
    ...
    parser.add_argument("--load-transformer-ckpt-path", type=str, default="saved_models", help="load ckpt")

    # dataset path
    parser.add_argument(
        "--test-maskedimage-path", type=str, default="./dataset/masked_image", help="Path to testing image dataset."
    )
    ...
    parser.add_argument("--total-iter", type=int, default=16, help="total step for mask scheduling")
